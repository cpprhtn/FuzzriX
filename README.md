...
**v0.11.0.** The thesis is *"LLM = fuzzing engineer + crash analyst."* Working today: the Docker-isolated
...
strategy selection, corpus management (seed-corpus bootstrap), deterministic dictionary mining, coverage-gap
diagnosis, and a coverage-improvement loop — validated on heavy domains (crypto/TLS,
