...
**v0.10.2.** The thesis is *"LLM = fuzzing engineer + crash analyst."* Working today: the Docker-isolated
...
strategy selection, corpus management, deterministic dictionary mining, coverage-gap diagnosis, and a
coverage-improvement loop — validated on heavy domains (crypto/TLS,
